    ...
    <div className="card-body">
      <ol className="text-justify">
        <li className="card-text">
          Click on the start button to begin the game. This will start the
          countdown timer at the top with a default of 1 minute for the game
          round.
        </li>
        <li className="card-text">
        ...
        <li className="card-text">
          ...
          <strong> Note: The game ends when the countdown gets to 0.</strong>
        </li>
        <li className="card-text">
